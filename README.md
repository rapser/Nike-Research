...
Luego, en Xcode, corre el app con el scheme **`Nike+Research-QA`** para apuntar a ese servidor local.

## Correr el app

1. Abrir `Nike+Research.xcodeproj` en Xcode.
2. Elegir el scheme (`Nike+Research-QA` para local, `Nike+Research` para producción/Render) en el dropdown superior.
3. Run (⌘R).
